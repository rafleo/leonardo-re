<svelte:head>
	<title>Privacy Policy &#8251; Leonardo Re</title>
	<meta property="og:title" content="Privacy Policy of leonardo.re" />
	<meta property="og:url" content="https://leonardo.re/legal" />
	<meta name="twitter:title" content="Privacy Policy of leonardo.re" />
	<meta
		name="description"
		content="This is the Privacy Policy for Leonardo Re's website at https://leonardo.re"
	/>
	<meta
	...
	<link rel="canonical" href="https://leonardo.re/legal" />
</svelte:head>

<div class="container wide">
	<div class="row">
		<div class="column">
			<h2><span>Privacy Policy</span> of leonardo.re</h2>
			<h3>This website collects some Personal Data from its Users.</h3>
		</div>
	</div>
</div>

<div
	class="container wide imagespacer leo-profile"
	role="img"
	aria-label="A picture of Leonardo Re"
></div>
		...
		<div class="column">
			...
			<div itemscope itemtype="http://schema.org/Person">
				<p>
					...
					<meta itemprop="jobTitle" content="Film Director" />
					<br />
	...
	<div class="row">
		<div class="column">
			...
			<p>
				...
				Data, collected automatically when using this Website.<br />Unless specified otherwise, all
				Data requested by this Website is mandatory and failure to provide this Data may make it
				impossible for this Website to provide its services. In cases where this Website
				...
				who are uncertain about which Personal Data is mandatory are welcome to contact the Owner.<br
	...
	<div class="row">
		<div class="column">
			...
			<p>
				...
				this Website (administration, sales, marketing, legal, system administration) or external
			...
			<ul>
				<li>
					...
					following legal bases. This, however, does not apply, whenever the processing of Personal
	...
	<div class="row">
		<div class="column">
			...
			<p>
				...
				well as for the following purposes:<br />
		...
		<div class="column">
			...
			<div class="tab" role="presentation">
				<input
					...
					type="checkbox"
					name="tabs-strato"
					aria-controls="tab-content-strato"
				/>
				<label for="tab-strato" id="tab-strato-label" role="heading" aria-level="6">Hosting</label>
				<div
					class="tab-content tab-content-long"
					id="tab-content-strato"
					role="region"
					aria-labelledby="tab-strato-label"
				>
					<p>
			...
			<div class="tab" role="presentation">
				<input
					id="tab-cloudflare"
					type="checkbox"
					name="tabs-cloudflare"
					aria-controls="tab-content-cloudflare"
				/>
				<label for="tab-cloudflare" id="tab-cloudflare-label" role="heading" aria-level="6"
					>Traffic optimization and distribution</label
				>
				<div
					class="tab-content tab-content-long"
					id="tab-content-cloudflare"
					role="region"
					aria-labelledby="tab-cloudflare-label"
				>
					<p>
						This type of service allows this Website to distribute their content using servers
						located across different countries and to optimize their performance.<br />
					...
					<p>
						...
						/>
						The way CloudFlare is integrated means that it filters all the traffic through this Website,
						i.e., communication between this Website and the User's browser, while also allowing analytical
						data from this Website to be collected.
					</p>
					<p>
...
<div class="container">
	<div class="row">
		<div class="column">
			...
			<ul>
				<li>
					<b>Withdraw their consent at any time.</b> Users have the right to withdraw consent where they
					have previously given their consent to the processing of their Personal Data.
				</li>
				<li>
					<b>Object to processing of their Data.</b> Users have the right to object to the processing
				...
				<li>
					<b>Access their Data.</b> Users have the right to learn if Data is being processed by the Owner,
					obtain disclosure regarding certain aspects of the processing and obtain a copy of the Data
					undergoing processing.
				</li>
				<li>
					<b>Verify and seek rectification.</b> Users have the right to verify the accuracy of their
					Data and ask for it to be updated or corrected.
				</li>
				<li>
					<b>Restrict the processing of their Data.</b> Users have the right, under certain circumstances,
					to restrict the processing of their Data. In this case, the Owner will not process their Data
				...
				<li>
					<b>Receive their Data and have it transferred to another controller.</b> Users have the right
					to receive their Data in a structured, commonly used and machine readable format and, if technically
					feasible, to have it transmitted to another controller without any hindrance. This provision
					is applicable provided that the Data is processed by automated means and that the processing
					is based on the User's consent, on a contract which the User is part of or on pre-contractual
					obligations thereof.
				</li>
				<li>
					<b>Lodge a complaint.</b> Users have the right to bring a claim before their competent data
...
<div class="container">
	<div class="row">
		<div class="column">
			...
			<p>
				This Website does not support “Do Not Track” requests.<br />To determine whether any of the
			...
			<p>
				...
				the date of the last modification listed at the bottom. If a User objects to any of the
				changes to the Policy, the User must cease using this Website and can request that the Owner
			...
			<div class="tab" role="presentation">
				...
				>
					...
					<p>
						...
						in this Website), which can include: the IP addresses or domain names of the computers utilized
						by the Users who use this Website, the URI addresses (Uniform Resource Identifier), the time
						of the request, the method utilized to submit the request to the server, the size of the
						file received in response, the numerical code indicating the status of the server's answer
						(successful outcome, error, etc.), the country of origin, the features of the browser and
						the operating system utilized by the User, the various time details per visit (e.g., the
						time spent on each page within the Website) and the details about the path followed within
						the Website with special reference to the sequence of pages visited, and other parameters
					...
					<p>
						...
						the security measures concerning the operation and use of this Website. The Data Controller,
